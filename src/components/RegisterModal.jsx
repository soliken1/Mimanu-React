        ...
        <form className="flex flex-col gap-4 mt-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <label className="text-xs text-gray-500 mt-2">
              This is displayed throughout the public website instead of their
              full name.
            </label>
          </div>
          ...
          <button
            type="submit"
            className="mt-4 bg-[#152852] hover:bg-[#0d1933] duration-300 text-white py-2 px-4 rounded-lg shadow-md"
          >
            Register
          </button>
        </form>
